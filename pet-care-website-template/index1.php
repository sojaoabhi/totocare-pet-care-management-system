        ...
        <div class="row py-3 px-lg-5">
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <h1 class="m-0 display-5 text-capitalize"><span class="text-primary">TOTO</span>CARE</h1>
                </a>
            </div>
            <div class="col-lg-8 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <div class="d-inline-flex flex-column text-center px-3 border-right">
                        <h6>Email Us</h6>
                        <p class="m-0">totocare.contact@gmail.com</p>
                    </div>
                    <div class="d-inline-flex flex-column text-center pl-3">
                        <h6>Call Us</h6>
                        <p class="m-0">+91 12345 6789</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                ...
                <a href="user_dashboard.php" class="btn btn-lg btn-primary px-3 d-none d-lg-block">Dashboard</a>
            </div>
        </nav>
    </div>
    <!-- Navbar End -->
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">TotoCare</h3>
                            <h1 class="display-3 text-white mb-3 animate__animated animate__fadeInDown">Where Love Meets Care</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">From cuddles to expert care, we provide everything your pet needs to thrive!</h5>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">Best Pet Services</h3>
                            <h1 class="display-3 text-white mb-3 animate__animated animate__fadeInDown">Pet Spa & Grooming</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">Because every pet deserves a little extra love</h5>
                            <a href="" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Book Now</a>
                            <a href="" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Learn More</a>
                        </div>
                    </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h3 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">Re-home And Adopt</h3>
                            <h1 class="display-3 text-white mb-3 animate__animated animate__fadeInDown">Every Pet Deserves a Good Home.</h1>
                            <h5 class="text-white mb-3 d-none d-sm-block animate__animated animate__fadeInDown">Approximately 1478 dogs & cats die every day on road in India. TotoCare is on a mission to provide every pet a home.</h5>
                            <a href="listing.html" class="btn btn-lg btn-primary mt-3 mt-md-4 px-4">Adopt Now</a>
                            <a href="adoptionform.html" class="btn btn-lg btn-secondary mt-3 mt-md-4 px-4">Re-home Pet</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="bg-light px-4 py-5 rounded">
                <div class="text-center">
                    <h1 class="text-secondary mb-3">Don't Have A Friend Adopt Then</h1>
                </div>
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-xl-3">
                                    <select class="form-select p-3 border-0">
                                        <option value="breed" class="">Your Choice Breed</option>
        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <form class="text-center mb-4" action="fetch_pets.php" method="post">
                        <div class="row g-4">
                            <div class="col-xl-10 col-lg-12">
                                <div class="row g-4">
                                    <div class="col-md-6 col-xl-4">
                                         <select class="form-control p-2 border-0">
                                            <option value="breed" class="" disabled selected>Pet Type</option>
                                            <option value="dog">Dog</option>
                                            <option value="cat">Cat</option>
                                        </select>
                                    </div>-->
                                    <!--<div class="col-md-6 col-xl-4">
                                       <select onchange="print_city('state', this.selectedIndex);" id="sts" name ="stt" class="form-control p-2 border-0" required></select>
                                   </div>
                                   <div class="col-md-6 col-xl-4">-->
                                    <!--<select onchange="print_city('state', this.selectedIndex);" id="sts" name="state" class="form-control p-2 border-0" required></select>
                                    <input name="state" class="form-control p-2 border-0" required placeholder="Enter State">
                                </div>-->
                                   <!--<div class="col-md-6 col-xl-4">
                                    <select id ="state" class="form-control p-2 border-0" required>Select City</select>
                                    <script language="javascript">print_state("sts");</script>
                               </div>
                               <div class="col-md-6 col-xl-4">-->
                                <!--<select id="state" name="city" class="form-control p-2 border-0" required>
                                    <option value="">Select City</option>
                                </select>
                                <script language="javascript">print_state("sts");</script>
                                <input name="city" class="form-control p-2 border-0" required placeholder="Enter City">
                            </div>
                                </div>

                            </div>
                            <div class="col-xl-2 col-lg-12">
                                <input type="button" class="btn btn-primary w-100 p-2 border-0" value="GET STARTED">
                            </div>
                        </div>
                    </form>
                </div>
...
<!--Adoption End-->
    ...
    <div class="container py-5">
        <div class="row py-5">
            <div class="col-lg-7 pb-5 pb-lg-0 px-3 px-lg-5">
                ...
                <h5 class="text-muted mb-3">Your pet's home away from home! Our safe, loving, and fun environment ensures they enjoy their stay with 24/7 care.</h5>
                <p class="mb-4">
                    At TotoCare, we provide a stress-free and comfortable boarding experience for your pets. Whether it's a short daycare stay or a longer vacation boarding, we ensure they receive expert care, daily exercise, and personalized attention. Our trained professionals offer a clean, safe, and playful environment, so you can relax knowing your pet is in the best hands.
                </p>
            ...
            <div class="row pb-3">
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>A safe, comfortable, and fun stay for your pet while you're away. Spacious accommodations, daily playtime, and loving care included!</p>
                ...
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>Nutritious, well-balanced meals tailored to your pet’s dietary needs, ensuring they stay healthy, happy, and energetic.</p>
                        <a class="text-uppercase font-weight-bold" href="">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>From baths to stylish trims, we keep your pet looking and feeling their best with professional grooming services.</p>
                        <a class="text-uppercase font-weight-bold" href="">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>Expert-led training sessions to teach obedience, social skills, and good behavior in a fun and positive way.</p>
                        <a class="text-uppercase font-weight-bold" href="">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>Daily exercise routines to keep your pet active, fit, and mentally stimulated through engaging play and walks.</p>
                        <a class="text-uppercase font-weight-bold" href="">Read More</a>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="d-flex flex-column text-center bg-white mb-2 p-3 p-sm-5">
                        ...
                        <p>Comprehensive health checkups and treatments by qualified vets to ensure your pet's overall well-being.</p>
                        <a class="text-uppercase font-weight-bold" href="">Read More</a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 py-5 py-lg-0 px-3 px-lg-5">
                ...
                <p class="mb-4">
                    At TotoCare, we believe that every pet deserves gentle, expert care in a safe and loving environment. From professional grooming to emergency services, we are committed to providing top-tier pet care with compassion and dedication. Whether it's a fun daycare stay or a relaxing spa session, we ensure your pet gets the best treatment possible.
                </p>
                <div class="row py-2">
                    <div class="col-6">
    ...
    <div class="container-fluid bg-dark text-white mt-5 py-5 px-sm-3 px-md-5">
        <div class="row pt-5">
            <div class="col-lg-4 col-md-12 mb-5">
                <h1 class="mb-3 display-5 text-capitalize text-white"><span class="text-primary">Toto</span>Care</h1>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        ...
                        <p><i class="fa fa-map-marker-alt mr-2"></i>Pune, India</p>
                        <p><i class="fa fa-phone-alt mr-2"></i>+91 12345 67890</p>
                        <p><i class="fa fa-envelope mr-2"></i>totocare.contact@gmail.com</p>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">
                    &copy; <a class="text-white font-weight-bold" href="index.html">totocare.com</a>. All Rights Reserved. Designed by
                    <a class="text-white font-weight-bold" href="index.html">Tech TotoCare</a>
                </p>
            </div>
    ...
    <script>
        ...
        let queryString = `listing.html?pet_type=${encodeURIComponent(petType)}&state=${encodeURIComponent(state)}&city=${encodeURIComponent(city)}`;
